...
<header class="d-flex flex-column justify-content-start" id="main-header"
    style="<?php echo set_background('/assets/img/header-bg.jpg'); ?>; background-attachment: fixed">
    <div class="container">
        <h1 class="display-3"> Cabinet GESMA</h1>
        <p>Une expertise à l'échelle des PME locales depuis 1998.</p>
        <a href="a-propos.html" class="btn-link">En savoir plus</a>
...
<section id="section-about">
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <h3 class="mb-4">Notre démarche</h3>
                <p class="text-justify">
                    <p>
...
<section id="section-word" style="<?php echo set_background('/assets/img/logos/vague.png'); ?>">
    <div class="container">
...
<section id="section-contact-now" class="mt-5" style="<?php echo set_background('/assets/img/logos/vague.png'); ?>">
...
<section id="section-news">
    <div class="container">
        <div class="row">
            ...
            <?php
            $recent_posts = wp_get_recent_posts( array( 'numberposts' => '2' ) );
            ?>

            <div class="col-lg-7">
                <a href=""><?php echo $recent_posts[0]['post_title']; ?></a>
    			<p class="_text-muted">Publié le <?php echo get_the_date( 'j F Y', $recent_posts[0]['ID'] ); ?></p>
    			<p><?php echo mb_strimwidth($recent_posts[0]['post_content'], 0, 200, '.'); ?></p>
            ...
            <div class="col">
                <a href=""><?php echo $recent_posts[1]['post_title']; ?></a>
    			<p class="_text-muted">Publié le <?php echo get_the_date( 'j F Y', $recent_posts[1]['ID'] ); ?></p>
    			<p><?php echo mb_strimwidth( $recent_posts[1]['post_content'], 0, 200, '.' ); ?></p>
...
<section id="section-newsletter" style="<?php echo set_background('/assets/img/logos/vague.png'); ?>">
    <div class="container">
